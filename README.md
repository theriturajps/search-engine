...
[![CI](https://github.com/theriturajps/Linux-Command/actions/workflows/ci.yml/badge.svg)](https://github.com/theriturajps/Linux-Command/actions/workflows/ci.yml)
...
[Github Web](http://jaywcjlove.github.io/linux-command/) | [Gitee Web](http://jaywcjlove.gitee.io/linux-command/) | [Githack](https://raw.githack.com/theriturajps/Linux-Command/gh-pages/index.html) | [Statically](https://cdn.statically.io/gh/theriturajps/Linux-Command/gh-pages/index.html)

扫描二维码移动端预览搜索，也可通过二维码下面链接地址打开使用，下面网站是通过 Github Action 自动更新。

⚠️ [Gitee Web](http://jaywcjlove.gitee.io/linux-command/) 存在 `违禁违规` 内容问题 [#283](https://github.com/theriturajps/Linux-Command/issues/283)。
...
你可以随意部署 web 版，这非常简单，只需要克隆 [`gh-pages`](https://github.com/theriturajps/Linux-Command/tree/gh-pages) 分支代码到你的静态服务就可以了。你也可以将 [`command`](https://github.com/theriturajps/Linux-Command/tree/master/command) 目录中的 Markdown 文件拿去自己生成 HTML。还可以使用下方 docker 方法部署 web 版。
...
微信小程序版本，由 [**@Matz Yang**](https://github.com/MatzYang) 提供 [#260](https://github.com/theriturajps/Linux-Command/issues/260)。
...
[Raycast 版本安装](https://www.raycast.com/theriturajps/Linux-Command)， ([**#338**](https://github.com/theriturajps/Linux-Command/issues/338))下图是界面效果： 
...
[Alfred 版本下载](https://github.com/theriturajps/Linux-Command/releases)， 下图是界面效果。 

<details>
<summary>Alfred 版本截图</summary>

<a href="https://github.com/theriturajps/Linux-Command/releases"><img width="556" alt="Alfred 版本截图" src="./assets/alfred.png" /></a>

</details>

## Dash 版本

由 [**@SHANG殇**](https://github.com/xinshangshangxin) 提供的 `Dash` 版本 [#91](https://github.com/theriturajps/Linux-Command/pull/91)，可配合 `alfred` 玩耍，下载 [linux-command.docset.tgz](https://github.com/theriturajps/Linux-Command/releases) 文件解压，点击安装即可。


<details>
<summary>Dash 版本截图</summary>

<a href="https://github.com/theriturajps/Linux-Command/releases"><img width="556" alt="Dash 版本截图" src="https://user-images.githubusercontent.com/8779091/57193499-5b475d00-6f6e-11e9-879d-e7e8fdc40ced.gif" /></a>
...
# 对应命令详情（Markdown）数据
https://raw.githubusercontent.com/theriturajps/Linux-Command/master/command/<命令名称>.md 
```
